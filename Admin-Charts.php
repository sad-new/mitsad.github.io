							...
							<div class="row">
								...
								<div class="col-sm-2 col-md-5 col-lg-3">
									<div class="form-group">
										<label>SY Term</label>
											<select class="form-control" id = "dropDown_SchoolYear">
											</select>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-5 col-lg-3">
									<div class="form-group">
										<label>Grade Level</label>
											<select class="form-control" id = "dropDown_GradeLevel">
											</select>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-5 col-lg-3">
									<div class="form-group">
										<label>Section</label>
											<select class="form-control" id = "dropDown_Section">
											</select>
									</div>
								</div>
								...
								<div class="col-sm-2 col-md-5 col-lg-3">
									<div class="form-group">
										<label>Subject</label>
											<select class="form-control" id = "dropDown_Subject">
											</select>
									</div>
								</div>
