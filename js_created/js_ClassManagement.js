...
async function loadMainTable()
{
    ...
    .then(function(result)
    {
        ...
        if (result != false)
        {
            ...
            studentCount = document.createElement('th');
            studentCount.colSpan = 2;
            tableHeadRow.appendChild(studentCount)
            ...
            for (var i = 0; i < result.length; i++)
            {
                ...
                // Student Count / Class Students

                var paragraph1 = document.createElement('p');
                paragraph1.setAttribute("data-placement","top");
                paragraph1.setAttribute("data-toggle","tooltip"); 
                paragraph1.setAttribute("title","Class Subject");

                var button_ClassStudent = document.createElement('button');
                button_ClassStudent.setAttribute("class","btn btn-primary btn-xs button_Main_ClassStudent"); 
                button_ClassStudent.setAttribute("data-title","Class Student"); 
                button_ClassStudent.setAttribute("name","ClassStudentButton");
                button_ClassStudent.setAttribute("value",  classSection['classID']  );

                var buttonTextNode1 = document.createTextNode("See Class List");
                ...
                paragraph2.setAttribute("title","Class Subject");
                ...
                var buttonTextNode2 = document.createTextNode("See Subject List");

 
                // Edit

                var paragraph3 = document.createElement('p');
                paragraph3.setAttribute("data-placement","top");
                paragraph3.setAttribute("data-toggle","tooltip"); 
                paragraph3.setAttribute("title","Edit");

                var button_EditSection = document.createElement('button');
                button_EditSection.setAttribute("class","btn btn-primary btn-xs button_Main_EditClass"); 
                ...
                button_EditSection.setAttribute("value",  classSection['classID']  );
                ...
                paragraph4.setAttribute("data-placement","top");
                paragraph4.setAttribute("data-toggle","tooltip"); 
                paragraph4.setAttribute("title","Delete");

                var button_DeleteSection = document.createElement('button');
                button_DeleteSection.setAttribute("class","btn btn-danger btn-xs button_Main_DeleteClass"); 
                ...
                button_DeleteSection.setAttribute("value",classSection['classID']  );

                var span4 = document.createElement('span');
                span4.setAttribute("class","glyphicon glyphicon-trash");
                ...
                tableBodyRow.appendChild(document.createElement('td'))
                    ...
                    .appendChild(button_ClassStudent)
                    .appendChild(buttonTextNode1);

                tableBodyRow.appendChild(document.createElement('td'))
                    .appendChild(paragraph2)
                    .appendChild(button_ClassSubject)
                    .appendChild(buttonTextNode2);
